  ...
  container.innerHTML = `
    <div class="page">
      <div class="page-intro">
        ...
        <p class="page-lede">Not the assessment methodology - this page tracks the status of the website itself: what's shipped and working, what's actively being built, and what's planned next. Started <b>${SITE_STARTED}</b> · Last updated <b>${SITE_LAST_UPDATED}</b>.</p>
      </div>

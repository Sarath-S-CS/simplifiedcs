...
const CASE_STUDIES = [
  { year:'2010', title:'Stuxnet', href:'https://www.cisa.gov/news-events/ics-advisories/icsa-10-272-01',
  ...
  { year:'2013', title:'Target Corporation data breach', href:'https://krebsonsecurity.com/2014/02/target-hackers-broke-in-via-hvac-company/',
  ...
  { year:'2014', title:'Sony Pictures hack', href:'https://www.fbi.gov/news/press-releases/update-on-sony-investigation',
  ...
  { year:'2017', title:'Equifax data breach', href:'https://www.gao.gov/assets/gao-18-559.pdf',
  ...
  { year:'2017', title:'WannaCry ransomware attack', href:'https://www.nao.org.uk/reports/investigation-wannacry-cyber-attack-and-the-nhs/',
  ...
  { year:'2017', title:'NotPetya', href:'https://www.cisa.gov/news-events/alerts/2017/07/01/petya-ransomware',
  ...
  { year:'2020', title:'SolarWinds hack', href:'https://www.cisa.gov/news-events/cybersecurity-advisories/aa20-352a',
  ...
  { year:'2021', title:'Colonial Pipeline ransomware attack', href:'https://www.cisa.gov/news-events/cybersecurity-advisories/aa21-131a',
  ...
  container.innerHTML = `
    <div class="page">
      <div class="page-intro">
        ...
        <p class="page-lede">${countWord.charAt(0).toUpperCase()}${countWord.slice(1)} watershed cybersecurity incidents - each one traces back to a gap this site is specifically built to catch before it becomes a headline.</p>
      </div>

      <div class="section-tile">
        <h3 class="section-h">Watershed incidents</h3>
        <div class="case-grid">
          ${[...CASE_STUDIES].sort((a,b)=>Number(b.year)-Number(a.year)).map(c=>`
            <div class="case-card">

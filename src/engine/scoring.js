...
// Each flag now carries a stable `id` (in addition to the original prose
// `text`, unchanged) so §2's MITRE ATT&CK + compensating-controls panel
// (src/engine/mitre-guidance.js) can look up a mapping per flag without
